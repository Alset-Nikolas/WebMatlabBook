"""
Django settings for matlab_book project.
...
SECRET_KEY = (
    "django-insecure-0-+o9@v_n9#yyv=il5@jxh8i%)-4t%60oag(!_mk0jilg=grdn"
)
...
WSGI_APPLICATION = "matlab_book.wsgi.application"
